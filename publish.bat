...
IF %help%==on (
   ...
   IF %copy%==on (
      robocopy C:\Users\Jim\Documents\webcontent\root-50webs  C:\Users\Jim\Documents\webcontent\github-website\springsandpucks ^
                  /XD .git ^
                  /XF .gitignore .htaccess publish.bat copyutilities.bat README.md ARCHITECTURE.md USER-MANUAL.md RUNBOOK.md LICENSE.txt socketio-chat* Box2D-* youTube* session* aoc* ^
                  /MIR /R:3 /W:5
   ) ELSE (
      ECHO(
